...
def productos(request):
    '''
    Esta función indica la carga de la pantalla que tiene el listado de 
    productos que pueden ser agregados al carrito de la Tienda Virtual
    '''
    productos = []
...
def pagos(request):
    '''
    Esta función indica la carga de la pantalla en la cual se realiza 
    el Pago de los productos que estén en el carrito de la Tienda Virtual
    '''
    costo = 0
    listado_productos = ""
